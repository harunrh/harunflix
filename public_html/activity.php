                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex mb-2">
                                        ...
                                        <div class="small">
                                            <span class="compact-date"><?php echo date('g:i A', strtotime($activity['created_at'])); ?></span>
                                            <span class="compact-date-mobile"><?php echo date('g:i', strtotime($activity['created_at'])); ?></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="review.php?id=<?php echo $activity['movie_id']; ?>" class="me-3">
                                                <img src="<?php echo $poster_url; ?>" alt="<?php echo $activity['movie_title']; ?>" 
                                                    ...
                                                    class="shadow-sm" onerror="this.src='assets/img/no-poster.jpg'">
                                            </a>
                                            <div>
