...
<!-- Movie Hero Banner -->
<div class="hero-section" style="background-image: url('<?php echo TMDB_IMAGE_BASE_URL . ($movie['backdrop_path'] ?? $movie['poster_path']); ?>');">
    <div class="container hero-content">
        <div class="row">
            <div class="col-md-8">
                <h1 class="hero-title"><?php echo $movie['title']; ?></h1>
                <div class="d-flex align-items-center mb-3">
                    <span class="badge bg-primary me-2"><?php echo isset($movie['vote_average']) ? number_format($movie['vote_average'], 1) : 'N/A'; ?>/10 TMDB</span>
                    <span class="text-light me-3"><?php echo $movie['release_date']; ?></span>
                    <?php if (isset($movie['runtime'])): ?>
                    <span class="text-light"><?php echo floor($movie['runtime']/60).'h '.($movie['runtime']%60).'m'; ?></span>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-md-4 d-none d-md-block">
                <img src="<?php echo TMDB_IMAGE_BASE_URL . $movie['poster_path']; ?>" alt="<?php echo $movie['title']; ?>" class="img-fluid rounded shadow" style="max-height: 300px;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="content-row">
                <h2 class="h4"><i class="fas fa-star me-2"></i>Reviews for <?php echo $movie['title']; ?></h2>
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0"><?php echo !empty($review['review_text']) ? $review['review_text'] : '<em class="text-muted">No written review</em>'; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-center mb-3 d-md-none">
                        <img src="<?php echo TMDB_IMAGE_BASE_URL . $movie['poster_path']; ?>" alt="<?php echo $movie['title']; ?>" class="img-fluid rounded" style="max-height: 250px;">
                    </div>
            ...
            <form action="review.php?id=<?php echo $movie_id; ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="rating" name="rating" min="1" max="10" step="0.1" value="8.0" required>
                    </div>
