    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <?php else: ?>
                    <div class="avatar rounded-circle text-white d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 150px; height: 150px; font-size: 60px;">
